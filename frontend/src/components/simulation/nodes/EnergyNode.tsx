...
const EnergyNode = memo(({ data, selected }: EnergyNodeProps) => {
  ...
  const handleDeleteClick = (e: React.MouseEvent) => {
    e.stopPropagation();
    if (data.onDeleteNode && window.confirm(`Are you sure you want to delete "${data.name}"?`)) {
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-1">
              ...
              <div 
                ...
                className="w-8 h-8 rounded bg-red-600/30 flex items-center justify-center cursor-pointer hover:bg-red-500/40 transition-all duration-200 group"
                title="Delete Node"
              >
                <svg className="w-4 h-4 text-red-300 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                </svg>
              </div>
            </div>
